    ...
    <div className="space-y-6" data-testid="tracker-root">
      ...
      <div className="glass p-4 sm:p-6 glass-hover min-w-0">
        <div className="flex flex-wrap items-center justify-between gap-4">
          <div>
            <div className="font-mono-data text-[10px] uppercase tracking-widest text-green">// Today’s activity record</div>
      ...
      <div className="grid lg:grid-cols-3 gap-5">
        <div className="glass p-4 sm:p-6 glass-hover lg:col-span-2 min-w-0" data-testid="activity-feed">
            ...
            {data.activities.map((a) => {
              ...
              return (
                <motion.div
                  key={a.id}
                  whileHover={{ x: 4 }}
                  className="flex items-center gap-3 sm:gap-4 p-3.5 rounded-xl bg-widget border border-white/[0.04] hover:border-green/20 transition"
                >
                  ...
                  <div className="font-mono-data text-base text-main shrink-0">{a.kg.toFixed(1)} kg</div>
                </motion.div>
              );
            })}
          </div>
        ...
        {/* Heatmap */}
        <div className="glass p-4 sm:p-6 glass-hover" data-testid="heatmap-card">
          ...
          <div className="grid grid-cols-7 gap-1.5 mt-4">
            {data.heatmap.map((entry, i) => {
              const intensity = Math.min(entry.kg / 10, 1);
              ...
              return (
                <motion.div
                  ...
                  title={`${entry.day}: ${entry.kg.toFixed(1)} kg`}
                />
              );
            })}
          </div>

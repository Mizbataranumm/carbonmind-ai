...
const features = [
  ...
  { icon: ShieldCheck, title: "Privacy-aware", desc: "Inspired by CarbonTracker research A your data stays your own." },
  ...
  return (
    <div className="min-h-screen relative overflow-hidden">
      ...
      <footer className="px-6 lg:px-12 py-10 border-t border-glass-border text-sm text-[#5C6B7A] flex flex-wrap justify-between gap-4">
        <div>CarbonMind AI © 2026 A A futuristic sustainability OS.</div>

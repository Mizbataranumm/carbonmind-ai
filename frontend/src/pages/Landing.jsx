    ...
    <div className="min-h-screen relative overflow-hidden">
      ...
      <nav className="relative z-20 px-6 lg:px-12 py-5 flex items-center justify-between">
        <div className="flex items-center gap-2.5">
          ...
          <span className="font-mono-data text-[10px] uppercase tracking-widest text-[#00FFB2] border border-[#00FFB2]/30 px-1.5 py-0.5 rounded">AI</span>
        </div>
        <div className="hidden md:flex items-center gap-7 text-sm text-[#9EABBC]">
          <a className="hover:text-white transition" href="#features">Features</a>
          <a className="hover:text-white transition" href="#research">Research</a>
          <a className="hover:text-white transition" href="#future">Future</a>
        </div>
      ...
      <section className="relative px-6 lg:px-12 pt-10 lg:pt-20 pb-32">
        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
          <div className="relative z-10">
            ...
            >
              <span className="h-1.5 w-1.5 rounded-full bg-[#00FFB2]" style={{ boxShadow: "0 0 10px #00FFB2" }} />
              <span className="font-mono-data text-[11px] uppercase tracking-widest text-[#9EABBC]">Your Intelligent Carbon Footprint Companion</span>
            </motion.div>
            ...
            <motion.p
              ...
              className="mt-6 text-[#9EABBC] text-lg max-w-xl leading-relaxed"
            >
            ...
            >
              {stats.map((s) => (
                <div key={s.label} className="glass p-4">
                  ...
                  <div className="text-xs text-[#9EABBC] mt-1">{s.label}</div>
          ...
          >
            ...
            >
              <div className="font-mono-data text-[10px] uppercase tracking-widest text-[#9EABBC]">Global health</div>
            ...
            >
              <div className="font-mono-data text-[10px] uppercase tracking-widest text-[#9EABBC]">Your aura</div>
              <div className="flex items-center gap-2 mt-1">
                <span className="h-3 w-3 rounded-full" style={{ background: "#00FFB2", boxShadow: "0 0 10px #00FFB2" }} />
      ...
      {/* FEATURES */}
      <section id="features" className="relative px-6 lg:px-12 py-24 border-t border-white/[0.06]">
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-6 mb-14">
            <div>
              <div className="font-mono-data text-[11px] uppercase tracking-widest text-[#00FFB2]">// Capabilities</div>
            ...
            <p className="text-[#9EABBC] max-w-md leading-relaxed">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5">
            {features.map((f, i) => (
              ...
              >
                <div className="h-11 w-11 rounded-xl bg-gradient-to-br from-[#00FFB2]/15 to-[#00D9FF]/10 border border-[#00FFB2]/20 flex items-center justify-center mb-5 group-hover:from-[#00FFB2]/25 transition-all">
                  <f.icon className="h-5 w-5 text-[#00FFB2]" />
                </div>
                <h3 className="font-display text-xl mb-2">{f.title}</h3>
                <p className="text-sm text-[#9EABBC] leading-relaxed">{f.desc}</p>
              </motion.div>
            ))}
          </div>
        </div>
      ...
      {/* RESEARCH */}
      <section id="research" className="relative px-6 lg:px-12 py-24 border-t border-white/[0.06]">
        <div className="max-w-7xl mx-auto grid lg:grid-cols-5 gap-10 items-center">
          <div className="lg:col-span-2">
            <div className="font-mono-data text-[11px] uppercase tracking-widest text-[#00FFB2]">// Research foundation</div>
            <h2 className="font-display text-4xl mt-3 leading-tight">Grounded in peer-reviewed sustainability AI.</h2>
            <p className="text-[#9EABBC] mt-4 leading-relaxed">
          ...
          <div className="lg:col-span-3 grid sm:grid-cols-2 gap-4">
            {[
              ...
              <div key={p.name} className="glass p-5 glass-hover">
                <div className="font-mono-data text-xs text-[#00D9FF] mb-1">PAPER</div>
                <div className="font-display text-lg">{p.name}</div>
                <div className="text-sm text-[#9EABBC] mt-1">{p.desc}</div>
              </div>
            ))}
          </div>
        </div>
      ...
      {/* CTA */}
      <section id="future" className="relative px-6 lg:px-12 py-28 border-t border-white/[0.06] overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto text-center">
          ...
          <p className="text-[#9EABBC] mt-6 max-w-xl mx-auto leading-relaxed">
      ...
      <footer className="px-6 lg:px-12 py-10 border-t border-white/[0.06] text-sm text-[#5C6B7A] flex flex-wrap justify-between gap-4">

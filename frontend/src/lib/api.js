...
export const getTransportCatalog = () => api.get("/transport/catalog").then(r => r.data);
export const estimateTransport = (payload) => api.post("/transport/estimate", payload).then(r => r.data);
...
export const predictWeekly = (payload) => api.post("/predict/weekly", payload).then(r => r.data);
